...
final class Scripttags extends AbstractPresentationObject
{
	public function assignData($sPage)
	{
		...
		$aScrips = array_merge($aScrips, array(
			...
			/** Jquery fileupload */
			'plugins/jquery-fileupload/js/vendor/jquery.ui.widget' 			=> array('recipes/add'),
			'plugins/jquery-fileupload/js/tmpl.min' 						=> array('recipes/add'),
			'plugins/jquery-fileupload/js/load-image.min' 					=> array('recipes/add'),
			'plugins/jquery-fileupload/js/canvas-to-blob.min' 				=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.blueimp-gallery.min' 		=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload' 				=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-process' 		=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-image' 			=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-audio' 			=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-video' 			=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-validate' 		=> array('recipes/add'),
			'plugins/jquery-fileupload/js/jquery.fileupload-ui' 			=> array('recipes/add'),
			'plugins/jquery-fileupload/js/main' 							=> array('recipes/add'),
			...
			/** Bootbox */
			//'plugins/bootbox/bootbox.min'									=> array('recipes/add'),
